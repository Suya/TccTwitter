...
def get_all_tweets(tag):
	...
	new_tweets = api.search(q = tag, rpp=200)
    #geocode="-22.9122,-43.2302,10km"
	...
	while len(alltweets) < 1000:
		...
		new_tweets = api.search(q = tag, rpp=15, since_id=newest)
	...
	#write the csv	
	with open('%s_tweets.csv' % tag, 'wb') as f:
		writer = csv.writer(f)
...
if __name__ == '__main__':
	#pass in the tag you want to download
	get_all_tweets("democrats")
